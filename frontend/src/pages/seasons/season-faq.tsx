    ...
    <div className="bg-secondary-background rounded-lg p-6 mt-4 text-secondary-text space-y-8">
      ...
      <section>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-4">
          <div className="bg-primary-background p-4 rounded-lg border border-secondary-text/10">
          ...
          <div className="bg-primary-background p-4 rounded-lg border border-secondary-text/10">
            ...
            <div className="font-bold text-lg text-primary-text">50 Points</div>
      ...
      <section>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-4 p-3 rounded-lg bg-primary-background border border-secondary-text/20">
            <div className="flex-shrink-0 w-6 h-6 rounded-full bg-secondary-background flex items-center justify-center text-xs font-bold text-secondary-text">1</div>
          ...
          <div className="flex items-center gap-4 p-3 rounded-lg bg-primary-background border border-secondary-text/20">
            <div className="flex-shrink-0 w-6 h-6 rounded-full bg-secondary-background flex items-center justify-center text-xs font-bold text-secondary-text">2</div>
            <div className="text-sm">
          ...
          <div className="flex items-center gap-4 p-3 rounded-lg bg-primary-background border border-secondary-text/20">
            <div className="flex-shrink-0 w-6 h-6 rounded-full bg-secondary-background flex items-center justify-center text-xs font-bold text-secondary-text">3</div>
            <div className="text-sm">
      ...
      <section className="space-y-4">
        ...
        <div className="border-l-4 border-secondary-text pl-4 py-1">
