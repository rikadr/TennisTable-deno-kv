      ...
      {playerIds
        ...
        .map((playerId) => (
          <button
            ...
            className="w-full px-3 py-2 bg-primary-background text-primary-text transition-all duration-200 hover:bg-secondary-background hover:text-secondary-text"
          >
