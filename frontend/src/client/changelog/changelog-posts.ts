...
export const CHANGELOG_POSTS: ChangelogPost[] = [
  {
    ...
    tags: ["feature-update"],
    summary:
      "The Baker 🧑‍🍳 is a new achievement for the player who gives away 5 donut sets. The achievement for 5 donut sets won is now Donut Glutton 🥯.",
    body: [
      text(
      ...
      text(
        "The achievement for 5 donut sets won keeps the same rule, but it has a new name: Donut Glutton 🥯. The previous name was Donuts to Share.",
      ),
    ],
  },
  {
